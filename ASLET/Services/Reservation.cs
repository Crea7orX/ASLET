...
public class Reservation
{
    ...
    public static Reservation GetReservation(int hashCode)
    {
        ...
        if (reservation == null)
        {
            int day = hashCode / (Constants.DAY_HOURS * NR);
            int hashCode2 = hashCode - (day * Constants.DAY_HOURS * NR);
            int room = hashCode2 / Constants.DAY_HOURS;
            int time = hashCode2 % Constants.DAY_HOURS;
    ...
    {
        return day * Constants.DAY_HOURS * NR + room * Constants.DAY_HOURS + time;
    }
